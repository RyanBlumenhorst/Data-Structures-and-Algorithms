def longest_common_substring_optimized(str1, str2):
    ...
    # Variables to remember the largest value, and the position it occurred at.
    max_value = 0
    max_value_row = 0
    for row in range(len(str1)):
        # Variable to hold the upper_left value from the current matrix position.
        up_left = 0
    ...
    # The longest common substring is the substring in str1 from index max_value_row - max_value + 1
